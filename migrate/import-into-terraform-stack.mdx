...
<Note>
  Importing into a Ravion standard library module (`rvn-s3`, `rvn-rds`, and so on)? See [Import into a standard module](/migrate/import-into-standard-module) instead. Not running your Terraform through Ravion yet? Start with [Run your existing Terraform with Ravion](/migrate/existing-terraform-stack).
</Note>
