...
- **Outputs** — the stack's Terraform outputs. Other modules consume these through [output references](/modules/output-references) like `<< modules.vpc.output.vpc_id >>`, which is how a web service module finds its cluster and network.
