...
If you use a `Dockerfile`, you can also bake it in with `ENV NODE_OPTIONS=--max-old-space-size=3072`. Environment variables set on the module override the image.
