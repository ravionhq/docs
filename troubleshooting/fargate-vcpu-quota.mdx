...
Size the quota for **at least twice** the sum of `vcpu × max_capacity` across every Fargate service in the region. That covers a full-scale rollout while scaled to the maximum.
